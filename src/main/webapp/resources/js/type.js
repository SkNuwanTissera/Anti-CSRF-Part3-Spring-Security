...
$(function(){
    $(".typed-effect").typed({
        strings: ["Tuped.js", "Typed.js.<br>It's a ^200<em>jQuery</em> plugin."], // ^{number} denotes time in ms to wait
    ...
    setTimeout ( function() {
        $(".testing-typed").typed({
            strings: ["Welcome ^333to ^111SLIIT "], // ^{number} denotes time in ms to wait
